...
def get_info(page):
    def mk_url_headers(page):
        t, m = ctx.call('get_t_m')
        url = (
            'http://match.yuanrenxue.com/api/match/16'
            '?page={}'
            '&m={}'
            '&t={}'
        ).format(page, m, t)
...
# 正常执行结果
# page:1 --> values:[1102, 8185, 7105, 5140, 9583, 7644, 3836, 6827, 9183, 8035]
# page:2 --> values:[6882, 4050, 4127, 627, 2707, 3422, 6159, 8575, 7434, 3215]
# page:3 --> values:[9207, 5728, 1859, 7689, 7515, 198, 6479, 2445, 628, 8582]
# page:4 --> values:[7769, 9273, 2978, 9947, 9843, 9535, 201, 3396, 8241, 4725]
# page:5 --> values:[4602, 7752, 559, 6395, 7251, 8595, 1075, 4738, 8709, 7631]
# sum:287383